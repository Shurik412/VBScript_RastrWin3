...
LinkCustomModels = "C:\CustomModels_64\"
...
if flag_2 = 1 then
    ...
    flag_multiplication_mj_zero = 0
	if flag_multiplication_mj_zero = 1 then 
    ...
    flag_Korr_Mj = 0
    if flag_Korr_Mj = 1 then 
        Call Korr_Mj() 
	end if 
    
    flag_DelAndChengeDublNumGen = 0
    if flag_DelAndChengeDublNumGen = 1 then
        For n = 0 to 2 
            Call DelAndChengeDublNumGen()   ' корректировка дублирующих генераторов (в том числе удаление если Name=Name).
        next
    end if 
    
    flag_ChangeVozbIEEE_b_c = 0
    if flag_ChangeVozbIEEE_b_c = 1 then
	...
	flag_Korr_ARS = 0
    if flag_Korr_ARS = 1 then
        Call Korr_ARS()
	end if
    
    flag_OffGenP_Q_Zero = 0
    if flag_OffGenP_Q_Zero = 1 then 
        Call OffGenP_Q_Zero()               ' - откл. ген. Pген=0 и Qген=0.
	end if  
    
    flag_OffGenIfNodeSta = 0
    if flag_OffGenIfNodeSta = 1 then
        Call OffGenIfNodeSta()              ' - откл. ген. с откл. узлами.
	end if
	...
	If ffff = 8999 Then
			...
			While Ex1.cells(i,1).value > 0 ' до тех пор пока в 1-м столбце (опеределение заполнен ли регион) Ex1 стоит 1
                If Ex1.cells(i,3).value > 0 Then ' если Nагр больше 0 то ...
					...
					While j<>-1 ' до тех пор пока j не равно -1
						...
						If gen.cols("Num").z(j) = Eny Then ' если название генератора  из Rastr равно назв ген из Excel						
		...
		If vozbuzd = 1 Then
			While Ex2.cells(i,1).value>0
                ...
                Num_gen = Ex2.cells(i,3)
				Id_generator = 0
				gen.SetSel("")
				j = gen.FindNextSel(-1)
				While j<>-1
					If gen.cols("Num").z(j) = Num_gen Then
...
Sub Equivalence()
    ...
    ' vyborka_gen = "((na>100 & na<200)| na=202 | na=203 | na=204 | na=205 | na=206 | na=207 | na=208 | na=209 | na=301 | na=302 | na=309 | na=311 | na=312 | na=401 | na=402 | na=404 | na=405 | na=405 | na=407 | na=408 | na=409 | na=801 | na=803 | na=804 | na=805 | na=806 | na=807 | na=813 | na=819 | na=820 | na=821 | na=822 | na=823 | na=824 | na=825 | na=826 | na=826 | na=827 | na=828 | na=829 | na=830 | na=831 | na=832) & (uhom=35 | uhom=110 | uhom=220) "
     vyborka_gen = "(na=102 | na=103 | na=104 | na=105 | na=106 | na=107 | na=108 | na=109 | na=110 | na=201 | na=202 | na=203 | na=204 | na=205 | na=206 | na=207 | na=208 | na=209 | na=301 | na=302 | na=303 | na=309 | na=310 | na=311 | na=312 | na=401 | na=402 | na=403 | na=404 | na=405 | na=405 | na=407 | na=408 | na=409 | na=801 | na=803 | na=805 | na=806 | na=807 | na=813 | na=819 | na=820) & (uhom < 150) &  (ny != 20125101)"
    ...
    vyborka_rayon = "(na=102 | na=103 | na=104 | na=105 | na=106 | na=107 | na=108 | na=109 | na=110 | na=201 | na=202 | na=203 | na=204 | na=205 | na=206 | na=207 | na=208 | na=209 | na=301 | na=302 | na=303 | na=309 | na=310 | na=311 | na=312 | na=401 | na=402 | na=403 | na=404 | na=405 | na=405 | na=407 | na=408 | na=409 | na=801 | na=803 | na=805 | na=806 | na=807 | na=813 | na=819 | na=820) & (uhom < 150) &  (ny != 20125101)"    
