...
if rst = 0 Then
    t.Save(FileRastr & "_" & HourNow & ".rst"),(Shablon & "динамика.rst")
    t.NewFile(Shablon & "динамика.rst")
    t.Load RG_REPL, FileRastr & "_" & HourNow & ".rst", Shablon & "динамика.rst"
end if
...
t.Save(FileRastr & "_" & HourNow & ":" & MinuteNow2 & ".rst"),(Shablon & "динамика.rst")
